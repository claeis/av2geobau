...
public class BBNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.BBNachfuehrung";
  public BBNachfuehrung(String oid) {
    super(tag,oid);
  }
