...
public class BoFlaeche extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.BoFlaeche";
  public BoFlaeche(String oid) {
    super(tag,oid);
  }
