...
public class EinzelpunktPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.EinzelpunktPos";
  public EinzelpunktPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_EinzelpunktPos_von="EinzelpunktPos_von";
  public String getEinzelpunktPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("EinzelpunktPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setEinzelpunktPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("EinzelpunktPos_von","REF");
