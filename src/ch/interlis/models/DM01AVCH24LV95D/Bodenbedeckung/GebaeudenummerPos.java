...
public class GebaeudenummerPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.GebaeudenummerPos";
  public GebaeudenummerPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_GebaeudenummerPos_von="GebaeudenummerPos_von";
  public String getGebaeudenummerPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("GebaeudenummerPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setGebaeudenummerPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("GebaeudenummerPos_von","REF");
