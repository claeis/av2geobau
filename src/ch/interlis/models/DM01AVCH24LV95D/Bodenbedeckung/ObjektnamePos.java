...
public class ObjektnamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.ObjektnamePos";
  public ObjektnamePos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ObjektnamePos_von="ObjektnamePos_von";
  public String getObjektnamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("ObjektnamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setObjektnamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ObjektnamePos_von","REF");
