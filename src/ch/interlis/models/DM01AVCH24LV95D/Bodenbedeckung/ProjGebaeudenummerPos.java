...
public class ProjGebaeudenummerPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.ProjGebaeudenummerPos";
  public ProjGebaeudenummerPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ProjGebaeudenummerPos_von="ProjGebaeudenummerPos_von";
  public String getProjGebaeudenummerPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("ProjGebaeudenummerPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setProjGebaeudenummerPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ProjGebaeudenummerPos_von","REF");
