...
public class ProjObjektnamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Bodenbedeckung.ProjObjektnamePos";
  public ProjObjektnamePos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ProjObjektnamePos_von="ProjObjektnamePos_von";
  public String getProjObjektnamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("ProjObjektnamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setProjObjektnamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ProjObjektnamePos_von","REF");
