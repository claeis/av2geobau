...
public class EONachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Einzelobjekte.EONachfuehrung";
  public EONachfuehrung(String oid) {
    super(tag,oid);
  }
