...
public class Einzelobjekt extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Einzelobjekte.Einzelobjekt";
  public Einzelobjekt(String oid) {
    super(tag,oid);
  }
  ...
  public ch.interlis.models.DM01AVCH24LV95D.Einzelobjekte.EOArt getArt() {
    String value=getattrvalue("Art");
    return ch.interlis.models.DM01AVCH24LV95D.Einzelobjekte.EOArt.parseXmlCode(value);
  }
  public void setArt(ch.interlis.models.DM01AVCH24LV95D.Einzelobjekte.EOArt value) {
    setattrvalue("Art", ch.interlis.models.DM01AVCH24LV95D.Einzelobjekte.EOArt.toXmlCode(value));
  }
