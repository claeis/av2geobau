...
public class LFP1 extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.FixpunkteKategorie1.LFP1";
  public LFP1(String oid) {
    super(tag,oid);
  }
  ...
  public LFP1_Begehbarkeit getBegehbarkeit() {
    String value=getattrvalue("Begehbarkeit");
    return LFP1_Begehbarkeit.parseXmlCode(value);
  }
  public void setBegehbarkeit(LFP1_Begehbarkeit value) {
    setattrvalue("Begehbarkeit", LFP1_Begehbarkeit.toXmlCode(value));
  }
