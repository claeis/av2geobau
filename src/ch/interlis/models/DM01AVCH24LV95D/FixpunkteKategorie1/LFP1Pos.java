...
public class LFP1Pos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.FixpunkteKategorie1.LFP1Pos";
  public LFP1Pos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_LFP1Pos_von="LFP1Pos_von";
  public String getLFP1Pos_von() {
    ch.interlis.iom.IomObject value=getattrobj("LFP1Pos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setLFP1Pos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("LFP1Pos_von","REF");
