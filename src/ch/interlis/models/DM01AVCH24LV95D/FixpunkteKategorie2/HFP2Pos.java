...
public class HFP2Pos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.FixpunkteKategorie2.HFP2Pos";
  public HFP2Pos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_HFP2Pos_von="HFP2Pos_von";
  public String getHFP2Pos_von() {
    ch.interlis.iom.IomObject value=getattrobj("HFP2Pos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setHFP2Pos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("HFP2Pos_von","REF");
