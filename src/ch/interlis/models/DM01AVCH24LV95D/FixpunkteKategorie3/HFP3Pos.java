...
public class HFP3Pos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.FixpunkteKategorie3.HFP3Pos";
  public HFP3Pos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_HFP3Pos_von="HFP3Pos_von";
  public String getHFP3Pos_von() {
    ch.interlis.iom.IomObject value=getattrobj("HFP3Pos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setHFP3Pos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("HFP3Pos_von","REF");
