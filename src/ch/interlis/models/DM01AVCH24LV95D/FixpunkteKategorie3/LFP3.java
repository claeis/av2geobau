...
public class LFP3 extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.FixpunkteKategorie3.LFP3";
  public LFP3(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_Protokoll="Protokoll";
  public LFP3_Protokoll getProtokoll() {
    String value=getattrvalue("Protokoll");
    return LFP3_Protokoll.parseXmlCode(value);
  }
  public void setProtokoll(LFP3_Protokoll value) {
    setattrvalue("Protokoll", LFP3_Protokoll.toXmlCode(value));
  }
