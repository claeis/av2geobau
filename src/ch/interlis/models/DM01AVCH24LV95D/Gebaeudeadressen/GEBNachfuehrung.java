...
public class GEBNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Gebaeudeadressen.GEBNachfuehrung";
  public GEBNachfuehrung(String oid) {
    super(tag,oid);
  }
