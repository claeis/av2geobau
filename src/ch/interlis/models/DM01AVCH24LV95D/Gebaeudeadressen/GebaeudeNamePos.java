...
public class GebaeudeNamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Gebaeudeadressen.GebaeudeNamePos";
  public GebaeudeNamePos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_GebaeudeNamePos_von="GebaeudeNamePos_von";
  public String getGebaeudeNamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("GebaeudeNamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setGebaeudeNamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("GebaeudeNamePos_von","REF");
