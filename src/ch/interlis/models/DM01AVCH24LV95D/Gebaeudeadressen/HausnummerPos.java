...
public class HausnummerPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Gebaeudeadressen.HausnummerPos";
  public HausnummerPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_HausnummerPos_von="HausnummerPos_von";
  public String getHausnummerPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("HausnummerPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setHausnummerPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("HausnummerPos_von","REF");
