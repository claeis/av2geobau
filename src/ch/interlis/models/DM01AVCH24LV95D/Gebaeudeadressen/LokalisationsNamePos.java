...
public class LokalisationsNamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Gebaeudeadressen.LokalisationsNamePos";
  public LokalisationsNamePos(String oid) {
    super(tag,oid);
  }
  public String getobjecttag() {
    return tag;
  }
  public final static String tag_AnfIndex="AnfIndex";
  public int getAnfIndex() {
    String value=getattrvalue("AnfIndex");
    return Integer.parseInt(value);
  }
  public void setAnfIndex(int value) {
    setattrvalue("AnfIndex", Integer.toString(value));
  }
  public final static String tag_EndIndex="EndIndex";
  public int getEndIndex() {
    String value=getattrvalue("EndIndex");
    return Integer.parseInt(value);
  }
  public void setEndIndex(int value) {
    setattrvalue("EndIndex", Integer.toString(value));
  }
  ...
  public final static String tag_Hilfslinie="Hilfslinie";
  public String getHilfslinie() {
    String value=getattrvalue("Hilfslinie");
    return value;
  }
  public void setHilfslinie(String value) {
    setattrvalue("Hilfslinie", value);
  }
  public final static String tag_LokalisationsNamePos_von="LokalisationsNamePos_von";
  public String getLokalisationsNamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("LokalisationsNamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setLokalisationsNamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("LokalisationsNamePos_von","REF");
