...
public class GEMNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Gemeindegrenzen.GEMNachfuehrung";
  public GEMNachfuehrung(String oid) {
    super(tag,oid);
  }
