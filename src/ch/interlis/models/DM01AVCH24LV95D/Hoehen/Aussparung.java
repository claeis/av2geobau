...
public class Aussparung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Hoehen.Aussparung";
  public Aussparung(String oid) {
    super(tag,oid);
  }
  ...
  public Aussparung_Art getArt() {
    String value=getattrvalue("Art");
    return Aussparung_Art.parseXmlCode(value);
  }
  public void setArt(Aussparung_Art value) {
    setattrvalue("Art", Aussparung_Art.toXmlCode(value));
  }
