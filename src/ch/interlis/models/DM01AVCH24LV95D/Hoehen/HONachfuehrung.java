...
public class HONachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Hoehen.HONachfuehrung";
  public HONachfuehrung(String oid) {
    super(tag,oid);
  }
