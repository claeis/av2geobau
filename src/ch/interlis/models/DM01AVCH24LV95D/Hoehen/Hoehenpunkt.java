...
public class Hoehenpunkt extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Hoehen.Hoehenpunkt";
  public Hoehenpunkt(String oid) {
    super(tag,oid);
  }
