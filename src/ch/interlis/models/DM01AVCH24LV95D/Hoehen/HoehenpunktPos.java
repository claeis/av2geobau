...
public class HoehenpunktPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Hoehen.HoehenpunktPos";
  public HoehenpunktPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_HoehenpunktPos_von="HoehenpunktPos_von";
  public String getHoehenpunktPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("HoehenpunktPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setHoehenpunktPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("HoehenpunktPos_von","REF");
