...
public class Grundstueck extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.Grundstueck";
  public Grundstueck(String oid) {
    super(tag,oid);
  }
  ...
  public Grundstueck_Gueltigkeit getGueltigkeit() {
    String value=getattrvalue("Gueltigkeit");
    return Grundstueck_Gueltigkeit.parseXmlCode(value);
  }
  public void setGueltigkeit(Grundstueck_Gueltigkeit value) {
    setattrvalue("Gueltigkeit", Grundstueck_Gueltigkeit.toXmlCode(value));
  }
  public final static String tag_Vollstaendigkeit="Vollstaendigkeit";
  public Grundstueck_Vollstaendigkeit getVollstaendigkeit() {
    String value=getattrvalue("Vollstaendigkeit");
    return Grundstueck_Vollstaendigkeit.parseXmlCode(value);
  }
  public void setVollstaendigkeit(Grundstueck_Vollstaendigkeit value) {
    setattrvalue("Vollstaendigkeit", Grundstueck_Vollstaendigkeit.toXmlCode(value));
  }
