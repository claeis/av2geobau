...
public class GrundstueckPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.GrundstueckPos";
  public GrundstueckPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_GrundstueckPos_von="GrundstueckPos_von";
  public String getGrundstueckPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("GrundstueckPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setGrundstueckPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("GrundstueckPos_von","REF");
