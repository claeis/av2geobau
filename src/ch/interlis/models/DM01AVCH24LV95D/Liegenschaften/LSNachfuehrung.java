...
public class LSNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.LSNachfuehrung";
  public LSNachfuehrung(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_GBEintrag="GBEintrag";
  public String getGBEintrag() {
    String value=getattrvalue("GBEintrag");
    return value;
  }
  public void setGBEintrag(String value) {
    setattrvalue("GBEintrag", value);
  }
  ...
  public final static String tag_Datum2="Datum2";
  public String getDatum2() {
    String value=getattrvalue("Datum2");
    return value;
  }
  public void setDatum2(String value) {
    setattrvalue("Datum2", value);
  }
}
