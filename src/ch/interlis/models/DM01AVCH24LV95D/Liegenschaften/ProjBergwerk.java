...
public class ProjBergwerk extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.ProjBergwerk";
  public ProjBergwerk(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ProjBergwerk_von="ProjBergwerk_von";
  public String getProjBergwerk_von() {
    ch.interlis.iom.IomObject value=getattrobj("ProjBergwerk_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setProjBergwerk_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ProjBergwerk_von","REF");
