...
public class ProjGrundstueckPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.ProjGrundstueckPos";
  public ProjGrundstueckPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ProjGrundstueckPos_von="ProjGrundstueckPos_von";
  public String getProjGrundstueckPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("ProjGrundstueckPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setProjGrundstueckPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ProjGrundstueckPos_von","REF");
