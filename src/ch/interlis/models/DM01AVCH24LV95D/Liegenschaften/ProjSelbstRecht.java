...
public class ProjSelbstRecht extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.ProjSelbstRecht";
  public ProjSelbstRecht(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_ProjSelbstRecht_von="ProjSelbstRecht_von";
  public String getProjSelbstRecht_von() {
    ch.interlis.iom.IomObject value=getattrobj("ProjSelbstRecht_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setProjSelbstRecht_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("ProjSelbstRecht_von","REF");
