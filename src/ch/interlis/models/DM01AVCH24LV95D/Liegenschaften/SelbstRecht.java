...
public class SelbstRecht extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Liegenschaften.SelbstRecht";
  public SelbstRecht(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_SelbstRecht_von="SelbstRecht_von";
  public String getSelbstRecht_von() {
    ch.interlis.iom.IomObject value=getattrobj("SelbstRecht_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setSelbstRecht_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("SelbstRecht_von","REF");
