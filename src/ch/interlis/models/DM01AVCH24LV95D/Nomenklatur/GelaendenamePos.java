...
public class GelaendenamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Nomenklatur.GelaendenamePos";
  public GelaendenamePos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_GelaendenamePos_von="GelaendenamePos_von";
  public String getGelaendenamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("GelaendenamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setGelaendenamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("GelaendenamePos_von","REF");
