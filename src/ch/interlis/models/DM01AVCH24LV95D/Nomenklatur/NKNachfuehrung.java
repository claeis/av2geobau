...
public class NKNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Nomenklatur.NKNachfuehrung";
  public NKNachfuehrung(String oid) {
    super(tag,oid);
  }
