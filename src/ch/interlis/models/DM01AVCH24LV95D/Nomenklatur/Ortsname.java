...
public class Ortsname extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Nomenklatur.Ortsname";
  public Ortsname(String oid) {
    super(tag,oid);
  }
