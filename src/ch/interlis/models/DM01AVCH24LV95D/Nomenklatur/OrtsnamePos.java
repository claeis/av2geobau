...
public class OrtsnamePos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Nomenklatur.OrtsnamePos";
  public OrtsnamePos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_OrtsnamePos_von="OrtsnamePos_von";
  public String getOrtsnamePos_von() {
    ch.interlis.iom.IomObject value=getattrobj("OrtsnamePos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setOrtsnamePos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("OrtsnamePos_von","REF");
