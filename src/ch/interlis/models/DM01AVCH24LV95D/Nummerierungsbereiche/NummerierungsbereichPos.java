...
public class NummerierungsbereichPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Nummerierungsbereiche.NummerierungsbereichPos";
  public NummerierungsbereichPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_NummerierungsbereichPos_von="NummerierungsbereichPos_von";
  public String getNummerierungsbereichPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("NummerierungsbereichPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setNummerierungsbereichPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("NummerierungsbereichPos_von","REF");
