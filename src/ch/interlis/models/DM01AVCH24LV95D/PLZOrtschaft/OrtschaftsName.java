...
public class OrtschaftsName extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.PLZOrtschaft.OrtschaftsName";
  public OrtschaftsName(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_OrtschaftsName_von="OrtschaftsName_von";
  public String getOrtschaftsName_von() {
    ch.interlis.iom.IomObject value=getattrobj("OrtschaftsName_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setOrtschaftsName_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("OrtschaftsName_von","REF");
