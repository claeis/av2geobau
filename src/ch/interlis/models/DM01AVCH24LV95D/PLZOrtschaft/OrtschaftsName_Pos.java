...
public class OrtschaftsName_Pos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.PLZOrtschaft.OrtschaftsName_Pos";
  public OrtschaftsName_Pos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_OrtschaftsName_Pos_von="OrtschaftsName_Pos_von";
  public String getOrtschaftsName_Pos_von() {
    ch.interlis.iom.IomObject value=getattrobj("OrtschaftsName_Pos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setOrtschaftsName_Pos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("OrtschaftsName_Pos_von","REF");
