...
public class PlanPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Planeinteilungen.PlanPos";
  public PlanPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_PlanPos_von="PlanPos_von";
  public String getPlanPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("PlanPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setPlanPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("PlanPos_von","REF");
