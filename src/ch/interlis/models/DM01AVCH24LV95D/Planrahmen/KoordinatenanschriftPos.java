...
public class KoordinatenanschriftPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Planrahmen.KoordinatenanschriftPos";
  public KoordinatenanschriftPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_KoordinatenanschriftPos_von="KoordinatenanschriftPos_von";
  public String getKoordinatenanschriftPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("KoordinatenanschriftPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setKoordinatenanschriftPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("KoordinatenanschriftPos_von","REF");
