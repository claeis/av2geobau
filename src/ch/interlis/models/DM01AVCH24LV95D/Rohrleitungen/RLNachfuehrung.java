...
public class RLNachfuehrung extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Rohrleitungen.RLNachfuehrung";
  public RLNachfuehrung(String oid) {
    super(tag,oid);
  }
