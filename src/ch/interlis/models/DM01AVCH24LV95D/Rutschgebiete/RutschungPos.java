...
public class RutschungPos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "DM01AVCH24LV95D.Rutschgebiete.RutschungPos";
  public RutschungPos(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_RutschungPos_von="RutschungPos_von";
  public String getRutschungPos_von() {
    ch.interlis.iom.IomObject value=getattrobj("RutschungPos_von",0);
    if(value==null)throw new IllegalStateException();
    String oid=value.getobjectrefoid();
    if(oid==null)throw new IllegalStateException();
    return oid;
  }
  public void setRutschungPos_von(String oid) {
    ch.interlis.iom.IomObject structvalue=addattrobj("RutschungPos_von","REF");
